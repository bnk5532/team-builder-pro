//fills in template literals in html template using unique property of each role to filter and map.
...
//template using template literals to fill in unique engineer answers from inquirer prompts.
...
//template using template literals to fill in unique manager answers from inquirer prompts.
...
//template using template literals to fill in unique intern answers from inquirer prompts.
...
//variable that stores the html template that executes once the file writes after all employees added.
